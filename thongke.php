...
<body>
    ...
    <div class="filters">
        ...
        <form action="thongke.php" method="post">
            ...
            <input type="checkbox" name="yearChecked" id="yearChecked" <?php $yearChecked && print('checked');?>>
    ...
    ?>
        ...
        <tr>
            <td colspan="8" align="right">
                Tổng thu: <?php echo number_format(array_sum($sotien), 0, ',', '.'); ?>đ
            </td>
        </tr>
    </table>
</body>
